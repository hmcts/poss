...
<xsl:stylesheet xmlns:ora="http://www.oracle.com/XSL/Transform/java" xmlns:supsfo="http://eds.com/supsfo" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:ns0="xmlns" ns0:xsl="http://www.w3.org/1999/XSL/Transform"><xsl:import href="supsfo.xsl"/><xsl:strip-space elements="*"/><xsl:output method="xml"/><xsl:template match="/"><editableSections><div class="EDITME" id="N10030"><div><font size="4" face="Arial">
		...
		<div style="margin-bottom: 0.4cm; font-weight: bold; text-align: center;">
			Appeal Number: <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdAppealNumber"/>
		</div>		
		<div style="margin-bottom: 0.4cm;">
			We are in receipt of your appeal dated <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdAppealDate"/>, copy attached.
		</div>
		<div style="margin-bottom: 0.8cm;">
			You must file the agreed notes of judgment in court in this case at least one week prior to the hearing for the District Judge's approval. Please arrange for the notes to be forwarded to the court.
		</div>

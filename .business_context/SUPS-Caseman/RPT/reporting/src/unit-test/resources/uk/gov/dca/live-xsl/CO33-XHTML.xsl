...
<xsl:stylesheet xmlns:ora="http://www.oracle.com/XSL/Transform/java" xmlns:supsfo="http://eds.com/supsfo" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:ns0="xmlns" ns0:xsl="http://www.w3.org/1999/XSL/Transform"><xsl:import href="supsfo.xsl"/><xsl:strip-space elements="*"/><xsl:output method="xml"/><xsl:template match="/"><editableSections><div class="EDITME" id="N100B8"><div><font size="2" face="Times New Roman">
		...
		<div style="margin-bottom: 1.2cm;">
			the objection of <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdObjectingCreditor"/>, having been received by the court outside the time prescribed by CCR, Order 39, rule 6(1) of Schedule 2 to the Civil Procedure Rules 1998, be disregarded.
		</div>
		...
		<xsl:if xmlns="http://eds.com/supsfo" test="$vdOrderMade != 'Y'">
			<div xmlns="">
				<table>
					<col width="728.784"/>
					<tbody>
						<tr>
							<td style="padding-left: 0.2cm; padding-right: 0.2cm; border-style: solid; border-width: 0.02cm;">
								...
								<div style="font-weight: bold; margin-top: 0.4cm;">

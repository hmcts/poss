			...
			<xsl:choose xmlns="http://eds.com/supsfo">
				<xsl:when test="string-length($vdJudgeTitle) &gt; 0">
					<div xmlns="" style="margin-bottom: 0.4cm;">
						Before <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdJudge"/> sitting at <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdHearingAtCourtNameDescription"/>, <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdHearingAtCourtAddress"/>.
					</div>
					<div xmlns="" style="margin-bottom: 0.4cm;">
				...
				<xsl:otherwise>
					<div xmlns="" style="margin-bottom: 0.4cm;">
						Before The Proper Officer sitting at <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdHearingAtCourtNameDescription"/>, <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdHearingAtCourtAddress"/>.
					</div>
					<div xmlns="" style="margin-bottom: 0.4cm;">
						<xsl:copy-of xmlns="http://eds.com/supsfo" select="$vdHearingAttendees"/>	
					</div>

...
<xsl:stylesheet xmlns:ora="http://www.oracle.com/XSL/Transform/java" xmlns:supsfo="http://eds.com/supsfo" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:ns0="xmlns" ns0:xsl="http://www.w3.org/1999/XSL/Transform"><xsl:import href="supsfo.xsl"/><xsl:strip-space elements="*"/><xsl:output method="xml"/><xsl:template match="/"><editableSections><div class="EDITME" id="N100AA"><div><font size="2" face="Times New Roman">
		...
		<div style="margin-bottom: 0.4cm;">
			<span style="font-weight: bold;">IT IS ORDERED that </span>this application for an Administration Order be <xsl:value-of xmlns="http://eds.com/supsfo" select="$vdDisStruckAdj"/>
		</div>
		<xsl:if xmlns="http://eds.com/supsfo" test="$vdDisStruckAdj = 'adjourned'">

...
# FILENAME      : $HeadURL$:
#
# SYNOPSIS      : Shell script to run the the mv_qbp creation script present in ddl_trac_646.sql.
...
###################################################################
# Execute the ddl_trac_646.sql script for the specified user and password
###################################################################
...
SET TERMOUT   ON
SET VERIFY    OFF
@${BASE_DIR}/${APP_NAME}/sql/ddl_trac_646.sql
exit
ENDSQL
SQLPLUS_RETURN_CODE=$?


#define the expected location of the ddl_trac_646.sql .out files
...
find  ${BASE_DIR}/${APP_NAME}/log/mview -name /ddl_trac_646* -mtime $REMOVE_OLDER_THAN  -exec rm -v {} \;

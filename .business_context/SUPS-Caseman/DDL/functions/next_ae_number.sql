/*-------------------------------------------------------------------------------
|
| FUNCTION      : NEXT_AE_NUMBER
|
| DESCRIPTION   : Retrieves the next AE number for a CaseMan AE
|				  by converting the next database sequence value into a string.
|				  AE number is 8 characters long, the first character is always 'A'
...
CREATE OR REPLACE FUNCTION "NEXT_AE_NUMBER"
RETURN VARCHAR2 IS

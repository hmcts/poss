...
########################################
#
# FILENAME      : $HeadURL: http://sups/svn/trunk/Caseman-CCBC/DDL/ddl_trac_1071_b.sh $:
#
# SYNOPSIS      : Shell script to run the the v_cman_parties creation script present in ddl_trac_1071_b.sql.
...
# $Id: ddl_trac_1071_b.sh 3409 2009-07-22 12:51:38Z westm $            Revision at last change
...
###################################################################
# Execute the ddl_trac_1071_b.sql script for the specified user and password
###################################################################
...
SET TERMOUT   ON
SET VERIFY    OFF
@${BASE_DIR}/${APP_NAME}/sql/ddl_trac_1071_b.sql
exit
ENDSQL
SQLPLUS_RETURN_CODE=$?


#define the expected location of the ddl_trac_1071_b.sql .out files
...
find  ${BASE_DIR}/${APP_NAME}/log/mview -name /ddl_trac_1071_b* -mtime $REMOVE_OLDER_THAN  -exec rm -v {} \;

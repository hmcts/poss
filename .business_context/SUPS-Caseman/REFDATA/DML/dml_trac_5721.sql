...
/*-------------------------------------------------------------------------------
|
| $HeadURL: http://sups/svn/trunk/Caseman-CCBC/REFDATA/DML/dml_trac_5721.sql $  
|
...
| $Id: dml_trac_5721.sql 12189 2015-12-16 15:42:57Z grewalg $         Revision at last change
|
--------------------------------------------------------------------------------*/

SPOOL dml_trac_5721.log
...
WHERE 	detail_code IN ('AC167','ACO18','ACO25','ACU18','ACU25','ALO18','ALU18',
		'ASO24','ASU24','BBSEV','BCARE','BCDIS','BCSEV','BFAMI','BHCPE','BHSPE'
		,'BSCPE','BSDIS','BSSEV','DDISA','BDISA','BSSPE','DCBFO','DCHIL');

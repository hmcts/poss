 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ECHRArticleProtocolProcessor extends AbstractXMLProcessor {
    private static final Log log = LogFactory.getLog(ECHRArticleProtocolProcessor.class);
    private static final String START_TAG = "<params><param name=\"ECHRArticleProtocol\">"; 
    private static final String END_TAG = "</param></params>";
    
    public ECHRArticleProtocolProcessor(IServiceType serviceType) {
        super(serviceType);
    }
    ...
    public void xmlProcessor(List params, Map keySeq, Document doc) throws SystemException {
        ...
        addEndTag(strBuf);
        ECHRArticleProtocolStr = strBuf.toString();
        ECHRArticleProtocolStr = replaceKeys(ECHRArticleProtocolStr, keySeq, doc, IXMLProcessor.CASEEVENT_KEY, "<EventSeq>", "//params//ManageCase//ECHRArticleProtocol//EventSeq");
        callService(ECHRArticleProtocolStr);
        }

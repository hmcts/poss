...
public class QueryDefParser {
		...
		throws QueryEngineException, ConfigurationException
	{
		...
		try {
			...
			m_errorHandler.raiseError("Unable to retreive any tables from 'DBMapDef/Tables/Table'");
			return;
		}
		...
		try {
			...
			m_errorHandler.raiseWarning("Unable to retreive any tables from query definitions 'Tables/Table'");
			return;
		}

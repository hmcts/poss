...
public class EJBServiceProxy
{
	...
	private final static String BUSINESS_EXCEPTION_CLASS = BusinessException.class.getName();
	private final static String SYSTEM_EXCEPTION_CLASS = SystemException.class.getName();
    	...
    	throws SystemException, BusinessException
    {
    	...
    	try {
    		...
    		if ( cause != null && BUSINESS_EXCEPTION_CLASS.compareTo(cause.getClass().getName()) == 0 ) 
    		{

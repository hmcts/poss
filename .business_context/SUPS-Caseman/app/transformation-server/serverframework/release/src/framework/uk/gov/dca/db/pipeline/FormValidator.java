 ...
 * @author Grant Miller
 */
public class FormValidator extends AbstractComponent implements IValidator {

	private static final Log log = LogFactory.getLog(FormValidator.class);
    	...
    	throws BusinessException, SystemException
    {
        ...
        try
		{
            ...
            if (!(funcObj instanceof Function)) {
                ...
                log.info("Result of calling Javascript function '"+JS_FUNCTION+"':" + Context.toString(result));
            }
        }
        finally {

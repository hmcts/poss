 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class EchoProcessor extends AbstractCustomProcessor {
	...
	public void process(Document inputParameters, Writer output, Log log) throws BusinessException, SystemException {
		...
		try {
			validation = (Element)XPath.selectSingleNode(inputParameters, "/params/param[@name='echo']");
			
			if(validation != null) {
				XMLOutputter geoff = new XMLOutputter();
				output.write(geoff.outputString(validation));
			}
		}

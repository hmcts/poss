 ...
 * 			 name="TestService"
 *           jndi-name="TestService"
 *			 local-jndi-name="ejb/TestServiceLocal"
 *           view-type="${ejb.interfaces}"
 *
 * @ejb.interface service-endpoint-class="uk.gov.dca.test_project.TestServiceService"
 *
 * @ejb.ejb-ref ejb-name="TestService"
 *				view-type="local"
 *				ref-name="ejb/TestServiceLocal"
 *
 ...
 *
 * @oc4j.bean jndi-name="TestService" pool-cache-timeout="0"
 *
 * @wsee.port-component name="TestServiceServicePort"
 * @jboss-net.web-service urn = "Test"
...
public class TestBean implements javax.ejb.SessionBean
{
    ...
    private final static String[] METHODS = {
        "uk/gov/dca/test_project/test_service/methods/xhtml_doc.xml","uk/gov/dca/test_project/test_service/methods/timeout.xml","uk/gov/dca/test_project/test_service/methods/get_xml_from_file.xml","uk/gov/dca/test_project/test_service/methods/timed_success.xml","uk/gov/dca/test_project/test_service/methods/validate_string.xml","uk/gov/dca/test_project/test_service/methods/succeed_toggle.xml"
    };
    private static final Log log = SUPSLogFactory.getLogger(TestBean.class);
    ...
    protected static final Log baseLog = LogFactory.getLog(TestBean.class);
    private final Log auditLog = SUPSLogFactory.getAuditLogger(TestBean.class.getName());
    ...
    public String ping() throws SystemException,
            BusinessException { 		
 		return "Ping: TestService is uk.gov.dca.test_project.TestBean";
 	}    /**
     ...
     * @throws Exception
     */
    public String xhtmlDoc(String user, String mac, String params) throws Exception
    {
        final String methodName = "xhtmlDoc";
     ...
     */
    public void xhtmlDocLocal (String params, Writer stream) throws BusinessException, SystemException
    {
        final String methodName = "xhtmlDoc";
        try {
     ...
     * @throws SystemException
     */
    public void xhtmlDocLocal2 (uk.gov.dca.db.pipeline.component_input.ComponentInput inputHolder, uk.gov.dca.db.pipeline.component_input.ComponentInput outputHolder) throws BusinessException, SystemException
    {
        final String methodName = "xhtmlDoc";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws Exception
     */
    public String timeout(String user, String mac, String params) throws Exception
    {
     ...
     * @throws SystemException
     */
    public void timeoutLocal (String params, Writer stream) throws BusinessException, SystemException
    {
        final String methodName = "timeout";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws SystemException
     */
    public void timeoutLocal2 (uk.gov.dca.db.pipeline.component_input.ComponentInput inputHolder, uk.gov.dca.db.pipeline.component_input.ComponentInput outputHolder) throws BusinessException, SystemException
    {
        final String methodName = "timeout";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws Exception
     */
    public String getXmlFromFile(String user, String mac, String params) throws Exception
    {
        final String methodName = "getXmlFromFile";
        final String securityInfo = "<Security roles=\"user\" />";
     ...
     * @throws SystemException
     */
    public void getXmlFromFileLocal (String params, Writer stream) throws BusinessException, SystemException
    {
        final String methodName = "getXmlFromFile";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws SystemException
     */
    public void getXmlFromFileLocal2 (uk.gov.dca.db.pipeline.component_input.ComponentInput inputHolder, uk.gov.dca.db.pipeline.component_input.ComponentInput outputHolder) throws BusinessException, SystemException
    {
        final String methodName = "getXmlFromFile";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws Exception
     */
    public String timedSuccess(String user, String mac, String params) throws Exception
    {
        final String methodName = "timedSuccess";
        final String securityInfo = "<Security roles=\"user\" />";
     ...
     * @throws SystemException
     */
    public void timedSuccessLocal (String params, Writer stream) throws BusinessException, SystemException
    {
        final String methodName = "timedSuccess";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws SystemException
     */
    public void timedSuccessLocal2 (uk.gov.dca.db.pipeline.component_input.ComponentInput inputHolder, uk.gov.dca.db.pipeline.component_input.ComponentInput outputHolder) throws BusinessException, SystemException
    {
        final String methodName = "timedSuccess";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws Exception
     */
    public String validateString(String user, String mac, String params) throws Exception
    {
        final String methodName = "validateString";
        final String securityInfo = "<Security roles=\"user\" />";
     ...
     * @throws SystemException
     */
    public void validateStringLocal (String params, Writer stream) throws BusinessException, SystemException
    {
        final String methodName = "validateString";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws SystemException
     */
    public void validateStringLocal2 (uk.gov.dca.db.pipeline.component_input.ComponentInput inputHolder, uk.gov.dca.db.pipeline.component_input.ComponentInput outputHolder) throws BusinessException, SystemException
    {
        final String methodName = "validateString";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws Exception
     */
    public String succeedToggle(String user, String mac, String params) throws Exception
    {
        final String methodName = "succeedToggle";
        final String securityInfo = "<Security roles=\"user\" />";
     ...
     * @throws SystemException
     */
    public void succeedToggleLocal (String params, Writer stream) throws BusinessException, SystemException
    {
        final String methodName = "succeedToggle";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();
     ...
     * @throws SystemException
     */
    public void succeedToggleLocal2 (uk.gov.dca.db.pipeline.component_input.ComponentInput inputHolder, uk.gov.dca.db.pipeline.component_input.ComponentInput outputHolder) throws BusinessException, SystemException
    {
        final String methodName = "succeedToggle";
        try {
        	uk.gov.dca.db.pipeline.CallStack cs = uk.gov.dca.db.pipeline.CallStack.getInstance();

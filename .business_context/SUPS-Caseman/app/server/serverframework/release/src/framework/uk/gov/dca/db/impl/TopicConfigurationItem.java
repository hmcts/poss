...
import uk.gov.dca.db.async.TopicHandler;
 ...
 *
 */
public class TopicConfigurationItem extends AbstractConfigurationItem
{
    ...
    public void initialise(Element eConfig) throws SystemException
    {
        ...
        handler = new TopicHandler(eConfig.getAttributeValue("id"), factory, jndiName, minPoolSize, maxPoolSize);
    }

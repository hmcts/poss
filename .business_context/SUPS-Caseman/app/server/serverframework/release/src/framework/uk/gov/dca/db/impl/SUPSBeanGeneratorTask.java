 ...
 *
 */
public class SUPSBeanGeneratorTask extends BeanGenerator
{
    ...
    {                
        getProject().log(this, "Setting Framework Config: " + frameworkConfig,Project.MSG_INFO);
    ...
    public void execute() throws BuildException
    {
        ...
        gen.setProject(getProject());
        gen.setTaskName("SUPSBeanGenerator");

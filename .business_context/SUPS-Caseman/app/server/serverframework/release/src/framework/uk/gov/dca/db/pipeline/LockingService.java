 ...
 * @author JamesB
 */
public class LockingService extends AbstractComponent2 implements IGenerator {
	...
	protected void process() throws SystemException, BusinessException {
		...
		Document doc = (Document)this.m_inputData.getData(Document.class);
		
		Element root = doc.getRootElement();
		String lockId = idGenerator.generateLockId(root);
		monitor.obtain(lockId);
		
		this.m_outputData.setData(doc, Document.class);
	}

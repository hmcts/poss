...
XPathConstants.DATA_XPATH = "/ds/HearingDetails";
XPathConstants.FORM_DATA_XPATH = "/ds/var/form/Subforms/HearingDetailsSubform";
...
hearingDetailsSubform.initialise = function()
{
	...
	if ( !CaseManUtils.isBlank(owningCourt) )
	{
	...
	else
	{
		...
		Services.setValue( HearingDetails_VenueCode.dataBinding, Services.getValue(XPathConstants.FORM_DATA_XPATH + "/HearingDetails/VenueCode") );
		Services.setValue( HearingDetails_HearingType.dataBinding, Services.getValue(XPathConstants.FORM_DATA_XPATH + "/HearingDetails/TypeOfHearing") );
		Services.setValue( HearingDetails_Date.dataBinding, Services.getValue(XPathConstants.FORM_DATA_XPATH + "/HearingDetails/Date") );
		Services.setValue( HearingDetails_Time.dataBinding, Services.getValue(XPathConstants.FORM_DATA_XPATH + "/HearingDetails/Time") );
		Services.setValue( HearingDetails_VenueAddressesGrid.dataBinding, Services.getValue(XPathConstants.FORM_DATA_XPATH + "/HearingDetails/Address/AddressId") );
	}
}

// Load the reference data from the xml into the model
hearingDetailsSubform.refDataServices = [
	{name:"HearingTypes", dataBinding:XPathConstants.SUBFORM_REF_DATA_XPATH, serviceName:"getHearingTypeList", serviceParams:[ { name: "hearingTypeList", constant: HearingParamsConstants.CASE }] },
...
hearingDetailsSubform.cancelLifeCycle = {
	...
	eventBinding: {	keys: [ { key: Key.F4, element: "hearingDetailsSubform" } ],
					singleClicks: [ {element: "HearingDetails_CancelButton"} ],
					doubleClicks: []
				  },
...
CourtsLOVGrid.logic = function(event)
{
	...
	if ( !CaseManUtils.isBlank(value) )
	{
		...
		var oldValue = Services.getValue(HearingDetails_VenueCode.dataBinding);
		if(oldValue == value)
		{
			return;
		}
...
function HearingDetails_HearingTypeLOVGrid() {};
HearingDetails_HearingTypeLOVGrid.dataBinding = XPathConstants.DATA_XPATH + "/TypeOfHearing";
HearingDetails_HearingTypeLOVGrid.srcData = XPathConstants.SUBFORM_REF_DATA_XPATH + "/HearingTypes";
HearingDetails_HearingTypeLOVGrid.rowXPath = "HearingType";
HearingDetails_HearingTypeLOVGrid.keyXPath = "Value";
HearingDetails_HearingTypeLOVGrid.columns = [
	{xpath: "Value"},
	{xpath: "Description"}
];

HearingDetails_HearingTypeLOVGrid.raise = {
	eventBinding: {
		singleClicks: [ {element: "HearingDetails_HearingTypeLOVButton"} ],
		keys: [ { key: Key.F6, element: "HearingDetails_HearingType" } ]
	}
};

/**
 * @author rzxd7g
 * @return "HearingDetails_HearingType"  
 */
HearingDetails_HearingTypeLOVGrid.nextFocusedAdaptorId = function() {
	return "HearingDetails_HearingType";
}
...
HearingDetails_VenueAddressesGrid.tabIndex = 8;
...
HearingDetails_ContactDetails_DX.dataBinding = XPathConstants.SUBFORM_REF_DATA_XPATH + "/Courts/Court[./Code = " + XPathConstants.DATA_XPATH + "/VenueCode]/ContactDetails/DX";
...
HearingDetails_VenueCode.helpText = "The court code of the hearing venue - list available";
...
HearingDetails_VenueName.logic = function()
{
	...
	var courtName = Services.getValue(XPathConstants.SUBFORM_REF_DATA_XPATH + "/Courts/Court[./Code = '" + value + "']/Name");
	if( null != courtName ) 
	{
...
HearingDetails_HearingType.tabIndex = 4;
HearingDetails_HearingType.helpText = "The type of hearing (eg. Small claim, Pre-Trial Review etc) - list available";
HearingDetails_HearingType.componentName = "Hearing Type";
HearingDetails_HearingType.srcData = XPathConstants.SUBFORM_REF_DATA_XPATH + "/HearingTypes";
HearingDetails_HearingType.rowXPath = "HearingType";
HearingDetails_HearingType.keyXPath = "Value";
HearingDetails_HearingType.displayXPath = "Value";
HearingDetails_HearingType.strictValidation = true;
HearingDetails_HearingType.isMandatory = function() { return true; }

/**********************************************************************************/

function HearingDetails_Time() {}
HearingDetails_Time.tabIndex = 7;
...
HearingDetails_Date.tabIndex = 6;
...
function HearingDetails_HearingTypeLOVButton() {}
HearingDetails_HearingTypeLOVButton.tabIndex = 5;

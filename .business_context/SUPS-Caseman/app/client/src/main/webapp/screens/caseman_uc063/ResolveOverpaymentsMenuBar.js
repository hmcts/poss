/** 
 * @fileoverview ResolveOverpaymentsMenuBar.js:
 * Configurations for UC063 (Resolve Overpayments) nav buttons and nav functions.
 *
 * @author Steve Blair
 */
...
Navigation_CreateCaseBtn.actionBinding = function()
{
	...
	else if(enforcementType == "FOREIGN WARRANT" || CaseManUtils.isBlank(caseNumber)) {
		Services.setTransientStatusBarMessage(Messages.CALL_CASE_NOT_ALLOWED);
		return;
	}
...
Navigation_WarrantsBtn.tabIndex = 31;
/**
 * @author tzzmr4
 * @return null 
 */
...
function navigateToScreen(screen)
{
	...
	var navArray = new Array(screen, NavigationController.RESOLVE_OVERPAYMENTS_FORM);

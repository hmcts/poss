...
function requestReport()
{
	...
	if ( CaseManValidationHelper.validateFields(Status_RunReportButton.validationList) ) { 
		...
		Reports.callAsync("asyncFamilyStatisticsReport", params, CaseMan_AsyncMonitor.srcData);
...
{
	var message = "An error occurred running the family enforcement statistics report";

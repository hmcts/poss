/** 
 * @fileoverview ViewHistAddresses_SubForm.js:
 * This file contains the configurations for the View Historical Addresses Subform
 *
...
XPathConstants.FORM_DATA_XPATH = "/ds/var/form/Subforms/ViewHistAddressesSubform/HistoricalAddresses";

/************************** FORM CONFIGURATIONS *************************************/

function viewHistAddressesSubform() {}

viewHistAddressesSubform.cancelLifeCycle = {

	eventBinding: {	keys: [ { key: Key.F4, element: "viewHistAddressesSubform" } ],
...
HistoricalAddress_ContactDetails_Address_Line1.isReadOnly = function() { return true; }
...
HistoricalAddress_ContactDetails_Address_Line2.isReadOnly = function() { return true; }
...
HistoricalAddress_ContactDetails_Address_Line3.isReadOnly = function() { return true; }
...
HistoricalAddress_ContactDetails_Address_Line4.isReadOnly = function() { return true; }
...
HistoricalAddress_ContactDetails_Address_Line5.isReadOnly = function() { return true; }
...
HistoricalAddress_ContactDetails_Address_Postcode.isReadOnly = function() { return true; }

/****************************** BUTTON FIELDS **************************************/

function HistoricalAddress_CloseButton() {};
HistoricalAddress_CloseButton.tabIndex = 1;

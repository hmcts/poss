/****************************************************************************************************************
						Run Start of Day Reports: CM_CAPS_LST, CM_AUTH_LST 	and others									
****************************************************************************************************************/
...
var textAreaBoilerPlateText = "    Running this option will print:\n" +
							  "    - outstanding N61 and N338\n" +
							  "    - a list of AEs requiring further action\n" +
							  "    - a list of events from CAPS\n\n" +
							  "    Do not run it until all today's N56 - Payments - Not\n" + 
							  "    served AE process have been logged";
							  				
Services.setValue(PAGE_BMSR_XPATH + "/TextAreaBoilerPlateText", textAreaBoilerPlateText);

     //Assign the AE_RUN_DATE Variable
     runDate = "AE RUNDATE";
...
/*****************************************************************************************************************
				...
				19-Apr-2006 - NOTE: This has been superceded by the Asynchronisation stuff and runStartOfDayReportsHandler is
 ...
 */
    ...
    {   
           ...
           var errorMsgElements = dom.selectNodes("ds/AeErrorMsgs/AeErrorMsg");
...
/**				19-Apr-2006 - NOTE: This has been superceded by the Asynchronisation stuff and runStartOfDayReports is
				never called. This was implemented as part of CR 0153 - KG						   
				   //Services.callService("runAeStartOfDayReports", params, runStartOfDayReportsHandler, true);  */
				   
				   Reports.callAsync("asyncAeStartOfDay", params, CaseMan_AsyncMonitor.srcData);

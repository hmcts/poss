/** 
 * @fileoverview CreatePaymentMenuBar.js:
 * Configurations for UC059 (Create Payments) nav buttons and nav functions.
 *
 * @author Steve Blair
 */
...
Navigation_CreateCaseBtn.tabIndex = 40;
/**
 * @author tzzmr4
 * @return null 
 */
...
Navigation_CaseEventsBtn.tabIndex = 41;
/**
 * @author tzzmr4
 * @return null 
 */
...
Navigation_WarrantsBtn.tabIndex = 42;
/**
 * @author tzzmr4
 * @return null 
 */
...
Navigation_QueryBtn.tabIndex = 45;
/**
 * @author tzzmr4
 * @return null 
 */
...
function navigateToScreen(screen)
{
	...
	var navArray = new Array(screen, Services.getValue(PAYMENT_METHOD_XPATH));

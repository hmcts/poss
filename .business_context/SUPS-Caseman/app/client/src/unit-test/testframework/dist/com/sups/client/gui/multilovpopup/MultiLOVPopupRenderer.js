...
// 
// This is a copy of the framework standard List of Values Popup with
// a multi select configuration.

// Define constructor function

function MultiLOVPopupRenderer() {};

/**
 * MultiLOVPopupRenderer is a sub class of Renderer
 */
MultiLOVPopupRenderer.prototype = new Renderer();
MultiLOVPopupRenderer.prototype.constructor = MultiLOVPopupRenderer;
...
MultiLOVPopupRenderer.POPUP_CSS_CLASS = "popup";
MultiLOVPopupRenderer.LOV_POPUP_CSS_CLASS = "multiLOVPopup popup";
MultiLOVPopupRenderer.LOV_POPUP_TABLE_CSS_CLASS = "lovPopupTable";
 ...
 *
 */
MultiLOVPopupRenderer.createInline = function(
	id,
	label,
	columns,
	rows,
...
)
{
	...
	return MultiLOVPopupRenderer._create(e, label, columns, rows, groupSize, isFiltered);
}
 ...
 *
 */
MultiLOVPopupRenderer.createAsInnerHTML = function(
	refElement,
	relativePos,
	id,
	label,
 ...
 *
 */
MultiLOVPopupRenderer.createAsChild = function(
	p,
	id,
	label,
	columns,
...
{
	e.className = MultiLOVPopupRenderer.LOV_POPUP_CSS_CLASS;

	var lov = new MultiLOVPopupRenderer();

...
function LOVSubformRenderer() {};

/**
 * LOVSubformRenderer is a sub class of Renderer
 */
LOVSubformRenderer.prototype = new Renderer();
LOVSubformRenderer.prototype.constructor = LOVSubformRenderer;
...
*
*/
LOVSubformRenderer.LOV_SUBFORM_CSS_CLASS = "popup lovsubform";
LOVSubformRenderer.LOV_SUBFORM_CSS_CLASS_NAME_FULLPAGE = "popup lovsubform popup_fullscreen";
 ...
 *
 */
LOVSubformRenderer.createInline = function(
	id,
	label,
	columns,
	rows,
...
)
{
	...
	return LOVSubformRenderer._create(e, label, columns, rows, groupSize, isFiltered);
}
 ...
 *
 */
LOVSubformRenderer.createAsInnerHTML = function(
	refElement,
	relativePos,
	id,
	label,
 ...
 *
 */
LOVSubformRenderer.createAsChild = function(
	p,
	id,
	label,
	columns,
...
{
	e.className = LOVSubformRenderer.LOV_SUBFORM_CSS_CLASS;

	var lov = new LOVSubformRenderer();

	// Initialise sets main element and the reference to the renderer in the dom
	lov._initRenderer(e);

	lov.m_label = label;
	lov.m_columns = columns;
	lov.m_rows = rows;
	lov.m_groupSize = groupSize;

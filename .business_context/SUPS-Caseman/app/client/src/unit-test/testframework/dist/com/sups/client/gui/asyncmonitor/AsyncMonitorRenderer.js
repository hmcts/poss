...
function AsyncMonitorRenderer(){};

/**
 * AsyncMonitorRenderer is a sub class of Renderer
 */
AsyncMonitorRenderer.prototype = new Renderer();
AsyncMonitorRenderer.prototype.constructor = AsyncMonitorRenderer;

AsyncMonitorRenderer.m_logger = new Category("AsyncMonitorRenderer");
AsyncMonitorRenderer.CSS_CLASS_NAME = "asyncMonitor";
 ...
 */
AsyncMonitorRenderer.createInline = function(id, isHideable)
{
	...
	return AsyncMonitorRenderer._create(e, isHideable);
}
...
{
	e.className = AsyncMonitorRenderer.CSS_CLASS_NAME;
	
	var am = new AsyncMonitorRenderer();

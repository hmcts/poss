...
/**
 * Automated tests for the Case Numbering changes to the Create Bailiff Payments screen.
 *
 * @author Chris Vincent
 */
public class CaseManNumbering_BailiffPayments_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CaseManNumbering_BailiffPayments_Test ()
    {
        super (CaseManNumbering_BailiffPayments_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC059BailiffPaymentUtils = new UC059BailiffPaymentUtils (this);
    }

    /**
     * Checks that Case Number field validation is as expected on the Create Bailiff Payments screen
    ...
    public void testCaseNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC059BailiffPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_CASE);

            // Enter a 7 digit case number to ensure it is rejected
            myUC059BailiffPaymentUtils.setEnforcementNumber ("3NN0001");
            ...
            {
                myUC059BailiffPaymentUtils.setEnforcementNumber (caseArray[i]);
    ...
    /**
     * Checks that Warrant Number field validation is as expected on the Create Bailiff Payments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC059BailiffPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            {
                myUC059BailiffPaymentUtils.setEnforcementNumber (invalidWarrantArray[i]);
            ...
            {
                myUC059BailiffPaymentUtils.setEnforcementNumber (validWarrantArray[i]);
    ...
    /**
     * Checks that Local Warrant Number field validation is as expected on the Create Bailiff Payments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testLocalWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC059BailiffPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_FOREIGNWARRANT);
    ...
    /**
     * Private function that logs the user into CaseMan and navigates to the Create Bailiff Payments screen.
     */

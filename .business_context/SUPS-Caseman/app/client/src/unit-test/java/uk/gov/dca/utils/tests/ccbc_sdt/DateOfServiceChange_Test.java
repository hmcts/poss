...
/**
 * Automated tests for the Date of Service change functionality in the CCBC SDT release.
 *
 * @author Chris Vincent
 */
public class DateOfServiceChange_Test extends AbstractCmTestBase
{
    ...
    /** The mcol code. */
    private String MCOL_CODE = "DS";

    /**
     * Constructor.
     */
    public DateOfServiceChange_Test ()
    {
        super (DateOfServiceChange_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC001CreateUpdateCaseUtils = new UC001CreateUpdateCaseUtils (this);
    }

    /**
     * Tests that when a defendant date of service changes on a Northampton owned non-MCOL, non-CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testDateOfServiceChange_1 ()
    {
        try
        {
            ...
            // Change the defendant date of service
            changeDateOfService ();
    ...
    /**
     * Tests that when a defendant date of service changes on a CCBC owned MCOL case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testDateOfServiceChange_2 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Manage Case screen
    ...
    /**
     * Tests that when a defendant date of service changes on a Northampton owned MCOL case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testDateOfServiceChange_3 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Manage Case screen
    ...
    /**
     * Tests that when a defendant date of service changes on a Northampton owned CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testDateOfServiceChange_4 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Manage Case screen
    ...
    /**
     * Tests that when a defendant date of service changes on a CCBC owned CCBC case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testDateOfServiceChange_5 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Manage Case screen
    ...
    /**
     * Private method to handle the change to date of service.
     */
    private void changeDateOfService ()
    {
        myUC001CreateUpdateCaseUtils.selectPartyByName ("DEFENDANT NAME");
        myUC001CreateUpdateCaseUtils.setDateOfService (AbstractBaseUtils.now ());

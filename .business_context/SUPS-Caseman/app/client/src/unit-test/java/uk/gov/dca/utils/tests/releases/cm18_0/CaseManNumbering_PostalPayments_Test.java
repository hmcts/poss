...
/**
 * Automated tests for the Case Numbering changes to the Create Postal Payments screen.
 *
 * @author Chris Vincent
 */
public class CaseManNumbering_PostalPayments_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CaseManNumbering_PostalPayments_Test ()
    {
        super (CaseManNumbering_PostalPayments_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC059PostalPaymentUtils = new UC059PostalPaymentUtils (this);
    }

    /**
     * Checks that Case Number field validation is as expected on the Create Postal Payments screen
    ...
    public void testCaseNumberValidationPreChange ()
    {
        try
        {
            ...
            // Get to the Create Postal Payments screen
            mLoginAndNavigateToScreen ();

            // Set Enforcement Type to CASE
            myUC059PostalPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_CASE);

            // Enter a 7 digit case number to ensure it is rejected
            myUC059PostalPaymentUtils.setEnforcementNumber ("3NN0001");
            ...
            {
                myUC059PostalPaymentUtils.setEnforcementNumber (caseArray[i]);
    ...
    /**
     * Checks that Warrant Number field validation is as expected on the Create Postal Payments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC059PostalPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            {
                myUC059PostalPaymentUtils.setEnforcementNumber (invalidWarrantArray[i]);
            ...
            {
                myUC059PostalPaymentUtils.setEnforcementNumber (validWarrantArray[i]);
    ...
    /**
     * Checks that Local Warrant Number field validation is as expected on the Create Postal Payments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testLocalWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC059PostalPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_FOREIGNWARRANT);
    ...
    /**
     * Private function that logs the user into CaseMan and navigates to the Create Postal Payments screen.
     */

...
/**
 * Automated tests ensuring that civil cases do produce a
 * REPORT_MAP row which is sent for bulk print.
 *
 * @author Chris Vincent
 */
public class RFS4813_5_Civil_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public RFS4813_5_Civil_Test ()
    {
        super (RFS4813_5_Civil_Test.class.getName ());

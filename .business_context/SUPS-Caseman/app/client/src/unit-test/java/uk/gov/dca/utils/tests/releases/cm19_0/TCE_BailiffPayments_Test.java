 ...
 */
public class TCE_BailiffPayments_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public TCE_BailiffPayments_Test ()
    {
        super (TCE_BailiffPayments_Test.class.getName ());
    ...
    public void testExecutionWarrantNonOverpayment ()
    {
        try
        {
            ...
            myUC059BailiffPaymentUtils.loadEnforcement (homeExecutionWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);

            // Create the payment, overpaying by 1.00
            String transactionNumber;
            myUC059BailiffPaymentUtils.setPaymentAmount ("191.00");
            ...
            myUC059BailiffPaymentUtils.loadEnforcement (foreignExecutionWarrant,
    ...
    public void testControlHomeWarrantNonOverpayment ()
    {
        try
        {
            ...
            myUC059BailiffPaymentUtils.loadEnforcement (homeControlWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            myUC059BailiffPaymentUtils.loadEnforcement (foreignControlWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_FOREIGNWARRANT);
    ...
    public void testExecutionWarrantOverpayment ()
    {
        try
        {
            ...
            String transactionNumber;
            myUC059BailiffPaymentUtils.setPaymentAmount ("191.01");
            myUC059BailiffPaymentUtils.setPaymentType (AbstractSuitorsCashScreenUtils.PAYMENT_TYPE_CASH);
            myUC059BailiffPaymentUtils.setRetentionType (AbstractSuitorsCashScreenUtils.RETENTION_TYPE_ORDINARY);
            transactionNumber = myUC059BailiffPaymentUtils.saveScreen ();
    ...
    public void testOtherWarrantOverpayments ()
    {
        try
        {
            ...
            myUC059BailiffPaymentUtils.loadEnforcement (possessionWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            myUC059BailiffPaymentUtils.loadEnforcement (deliveryWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            myUC059BailiffPaymentUtils.loadEnforcement (committalWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);

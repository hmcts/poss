...
/**
 * Automated tests for the Defendant Address functionality in the CCBC SDT release.
 *
 * @author Chris Vincent
 */
public class DefendantAddressChange_Test extends AbstractCmTestBase
{
    ...
    /** The mcol code. */
    private String MCOL_CODE = "DA";

    /**
     * Constructor.
     */
    public DefendantAddressChange_Test ()
    {
        super (DefendantAddressChange_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC001CreateUpdateCaseUtils = new UC001CreateUpdateCaseUtils (this);
    }

    /**
     * Tests that when a Northampton owned non-MCOL, non-CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testDefendantAddressChange_1 ()
    {
        try
        {
            ...
            // Change the defendant address
            changeDefendantAddress ();
    ...
    /**
     * Tests that when a defendant address change occurs on a CCBC owned MCOL case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testDefendantAddressChange_2 ()
    {
        try
        {
    ...
    /**
     * Tests that when a defendant address change occurs on a Northampton owned MCOL case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testDefendantAddressChange_3 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when a defendant address change occurs on a Northampton owned CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testDefendantAddressChange_4 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when a defendant address change occurs on a CCBC owned CCBC case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testDefendantAddressChange_5 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
     ...
     */
    private void changeDefendantAddress () throws Exception
    {
        myUC001CreateUpdateCaseUtils.selectPartyByName ("DEFENDANT NAME");
        myUC001CreateUpdateCaseUtils.addNewNonSolAddress ();
        myUC001CreateUpdateCaseUtils.setNewNonSolAddrLine1 ("NEW DEFENDANT ADDRESS LINE 1");
        myUC001CreateUpdateCaseUtils.setNewNonSolAddrLine2 ("NEW DEFENDANT ADDRESS LINE 2");
        myUC001CreateUpdateCaseUtils.setNewNonSolAddrLine3 ("NEW DEFENDANT ADDRESS LINE 3");
        myUC001CreateUpdateCaseUtils.setNewNonSolAddrLine4 ("NEW DEFENDANT ADDRESS LINE 4");
        myUC001CreateUpdateCaseUtils.setNewNonSolAddrLine5 ("NEW DEFENDANT ADDRESS LINE 5");

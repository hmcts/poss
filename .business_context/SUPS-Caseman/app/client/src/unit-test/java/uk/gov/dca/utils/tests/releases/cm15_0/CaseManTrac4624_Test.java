...
/**
 * Automated tests for the CaseMan Defect 4264.
 *
 * Test to prevent a user adding leading or trailing spaces to the OverPayee name when entering the
 * same Overpayee Name and Payee Name
 *
 * @author Des Johnston
 */
public class CaseManTrac4624_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CaseManTrac4624_Test ()
    {
        super (CaseManTrac4624_Test.class.getName ());
    ...
    public void testOverpayeeNameValidation ()
    {
        try
        {
            ...
            // Load the newly created payment with leading and trailing zeros for the OverPayee Name
            ...
            myUC063ResolveOverpaymentUtils.getOverpaymentAmount ();

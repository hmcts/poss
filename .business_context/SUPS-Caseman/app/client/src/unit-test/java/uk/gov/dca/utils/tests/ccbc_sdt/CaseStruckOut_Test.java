...
/**
 * Automated tests for the Case Struck Out functionality in the CCBC SDT release.
 *
 * @author Chris Vincent
 */
public class CaseStruckOut_Test extends AbstractCmTestBase
{
    ...
    /** The event 72. */
    private String EVENT_72 = "72";
    
    /** The mcol code1. */
    private String MCOL_CODE1 = "K1";
    
    /** The mcol code2. */
    private String MCOL_CODE2 = "K0";

    /**
     * Constructor.
     */
    public CaseStruckOut_Test ()
    {
        super (CaseStruckOut_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC002CaseEventUtils = new UC002CaseEventUtils (this);
    }

    /**
     * Tests that when Case Event 72 is created on a Northampton owned non-MCOL, non-CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent72_1 ()
    {
        try
        {
    ...
    /**
     * Tests that when Case Event 72 is created on a CCBC owned MCOL case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent72_2 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 72 is created on a Northampton owned MCOL case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent72_3 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 72 is created on a Northampton owned CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent72_4 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 72 is created on a CCBC owned CCBC case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent72_5 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Private method to handle the creation of case event 72.
     *
     * @throws Exception Exception thrown creating event
     */
    private void createCaseEvent72 () throws Exception
    {
        /**
         * Create Event 72
         * No Subject
         ...
         * FCK Editor
         */
        final NewStandardEvent testEvent57 = new NewStandardEvent (EVENT_72);

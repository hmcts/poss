 ...
 */
public class CaseManNumbering_CounterPayments_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CaseManNumbering_CounterPayments_Test ()
    {
        super (CaseManNumbering_CounterPayments_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC059CounterPaymentUtils = new UC059CounterPaymentUtils (this);
    }

    /**
     * Checks that Case Number field validation is as expected on the Create Counter Payments screen
    ...
    public void testCaseNumberValidationPreChange ()
    {
        try
        {
            ...
            // Get to the Create Counter Payments screen
            mLoginAndNavigateToScreen ();

            // Set Enforcement Type to CASE
            myUC059CounterPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_CASE);

            // Enter a 7 digit case number to ensure it is rejected
            myUC059CounterPaymentUtils.setEnforcementNumber ("3NN0001");
            ...
            {
                myUC059CounterPaymentUtils.setEnforcementNumber (caseArray[i]);
    ...
    /**
     * Checks that Warrant Number field validation is as expected on the Create Counter Payments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC059CounterPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            {
                myUC059CounterPaymentUtils.setEnforcementNumber (invalidWarrantArray[i]);
            ...
            {
                myUC059CounterPaymentUtils.setEnforcementNumber (validWarrantArray[i]);
    ...
    /**
     * Checks that Local Warrant Number field validation is as expected on the Create Counter Payments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testLocalWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC059CounterPaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_FOREIGNWARRANT);

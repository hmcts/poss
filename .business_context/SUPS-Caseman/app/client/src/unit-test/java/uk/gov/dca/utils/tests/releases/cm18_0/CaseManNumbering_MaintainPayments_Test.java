...
/**
 * Automated tests for the Case Numbering changes to the Maintain Payments screen.
 *
 * @author Chris Vincent
 */
public class CaseManNumbering_MaintainPayments_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CaseManNumbering_MaintainPayments_Test ()
    {
        super (CaseManNumbering_MaintainPayments_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC061MaintainPaymentUtils = new UC061MaintainPaymentUtils (this);
    }

    /**
     * Checks that Case Number field validation is as expected on the Maintain Payments screen
    ...
    public void testCaseNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC061MaintainPaymentUtils.setEnforcementNumber ("3NN0001");
            ...
            {
                myUC061MaintainPaymentUtils.setEnforcementNumber (caseArray[i]);
    ...
    /**
     * Checks that Warrant Number field validation is as expected on the Maintain Payments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            {
                myUC061MaintainPaymentUtils.setEnforcementNumber (invalidWarrantArray[i]);
            ...
            {
                myUC061MaintainPaymentUtils.setEnforcementNumber (validWarrantArray[i]);
    ...
    /**
     * Checks that Local Warrant Number field validation is as expected on the Maintain Payments screen
     * BEFORE the new numbering scheme comes into place.
     */

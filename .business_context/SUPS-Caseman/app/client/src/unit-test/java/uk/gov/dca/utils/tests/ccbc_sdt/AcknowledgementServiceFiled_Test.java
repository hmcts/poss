 ...
 */
public class AcknowledgementServiceFiled_Test extends AbstractCmTestBase
{
    ...
    /** The event 38. */
    private String EVENT_38 = "38";
    
    /** The mcol code1. */
    private String MCOL_CODE1 = "AS";
    
    /** The mcol code2. */
    private String MCOL_CODE2 = "A0";

    /**
     * Constructor.
     */
    public AcknowledgementServiceFiled_Test ()
    {
        super (AcknowledgementServiceFiled_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC002CaseEventUtils = new UC002CaseEventUtils (this);
    }

    /**
     * Tests that when Case Event 38 is created on a Northampton owned non-MCOL, non-CCBC case, that no
    ...
    public void testCaseEvent38_1 ()
    {
        try
        {
            ...
            myUC002CaseEventUtils.selectCaseEventByEventId (EVENT_38);
    ...
    /**
     * Tests that when Case Event 38 is created on a CCBC owned MCOL case, that a
     * notification is written to the MCOL_DATA table.
     */
    ...
    /**
     * Tests that when Case Event 38 is created on a Northampton owned MCOL case, that no
     * notification is written to the MCOL_DATA table.
     */
    ...
    /**
     * Tests that when Case Event 38 is created on a Northampton owned CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    ...
    /**
     * Tests that when Case Event 38 is created on a CCBC owned CCBC case, that a
     * notification is written to the MCOL_DATA table.
     */
    ...
    /**
     * Private method to handle the creation of case event 38.
     *
     * @throws Exception Exception thrown creating event
     */
    private void createCaseEvent38 () throws Exception
    {
        /**
         * Create Event 38
         * Enter Subject
         ...
         * FCK Editor
         */
        final NewStandardEvent testEvent38 = new NewStandardEvent (EVENT_38);
        testEvent38.setSubjectParty ("Defendant 1 - DEFENDANT NAME");
        testEvent38.setProduceOutputFlag (false);

        // Add the event
        myUC002CaseEventUtils.addNewEvent (testEvent38, null);
    }

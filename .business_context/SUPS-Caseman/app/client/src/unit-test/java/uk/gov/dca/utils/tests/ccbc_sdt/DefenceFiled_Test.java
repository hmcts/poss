...
/**
 * Automated tests for the Defence Filed functionality in the CCBC SDT release.
 *
 * @author Chris Vincent
 */
public class DefenceFiled_Test extends AbstractCmTestBase
{
    ...
    /** The event 50. */
    private String EVENT_50 = "50";
    
    /** The mcol code1. */
    private String MCOL_CODE1 = "DE";
    
    /** The mcol code2. */
    private String MCOL_CODE2 = "E0";

    /**
     * Constructor.
     */
    public DefenceFiled_Test ()
    {
        super (DefenceFiled_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC002CaseEventUtils = new UC002CaseEventUtils (this);
    }

    /**
     * Tests that when Case Event 50 is created on a Northampton owned non-MCOL, non-CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent50_1 ()
    {
        try
        {
    ...
    /**
     * Tests that when Case Event 50 is created on a CCBC owned MCOL case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent50_2 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 50 is created on a Northampton owned MCOL case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent50_3 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 50 is created on a Northampton owned CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent50_4 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 50 is created on a CCBC owned CCBC case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent50_5 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Private method to handle the creation of case event 50.
     *
     * @throws Exception Exception thrown creating event
     */
    private void createCaseEvent50 () throws Exception
    {
        /**
         * Create Event 50
         * Enter Subject
         ...
         * FCK Editor
         */
        final NewStandardEvent testEvent50 = new NewStandardEvent (EVENT_50);
        testEvent50.setSubjectParty ("Defendant 1 - DEFENDANT NAME");
        testEvent50.setProduceOutputFlag (false);

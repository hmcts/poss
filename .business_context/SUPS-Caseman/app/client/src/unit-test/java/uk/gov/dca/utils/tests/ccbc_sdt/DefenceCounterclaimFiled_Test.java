...
/**
 * Automated tests for the Defence and Counterclaim functionality in the CCBC SDT release.
 *
 * @author Chris Vincent
 */
public class DefenceCounterclaimFiled_Test extends AbstractCmTestBase
{
    ...
    /** The event 52. */
    private String EVENT_52 = "52";
    
    /** The mcol code1. */
    private String MCOL_CODE1 = "DC";
    
    /** The mcol code2. */
    private String MCOL_CODE2 = "D0";

    /**
     * Constructor.
     */
    public DefenceCounterclaimFiled_Test ()
    {
        super (DefenceCounterclaimFiled_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC002CaseEventUtils = new UC002CaseEventUtils (this);
    }

    /**
     * Tests that when Case Event 52 is created on a Northampton owned non-MCOL, non-CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent52_1 ()
    {
        try
        {
            ...
            // Create case event 52
            createCaseEvent52 (false);

            // Check that no MCOL_DATA row has been written
            assertEquals (0, DBUtil.getCountMCOLDataRowsForCase (caseNumber1, MCOL_CODE1));

            // Error off the Case Event 52
            myUC002CaseEventUtils.selectCaseEventByEventId (EVENT_52);
    ...
    /**
     * Tests that when Case Event 52 is created on a CCBC owned MCOL case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent52_2 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 52 is created on a Northampton owned MCOL case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent52_3 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 52 is created on a Northampton owned CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent52_4 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 52 is created on a CCBC owned CCBC case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent52_5 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Private method to handle the creation of case event 52.
     *
     * @param ccbcCase True if a CCBC Case, else false
     * @throws Exception Exception thrown creating event
     */
    private void createCaseEvent52 (final boolean ccbcCase) throws Exception
    {
        /**
         * Create Event 52
         * Enter Subject
         ...
         * FCK Editor
         */
        final NewStandardEvent testEvent52 = new NewStandardEvent (EVENT_52);
        testEvent52.setSubjectParty ("Defendant 1 - DEFENDANT NAME");
        testEvent52.setProduceOutputFlag (false);
        testEvent52.setCCBCCase (ccbcCase);

        // Add the event
        myUC002CaseEventUtils.addNewEvent (testEvent52, null);
    }

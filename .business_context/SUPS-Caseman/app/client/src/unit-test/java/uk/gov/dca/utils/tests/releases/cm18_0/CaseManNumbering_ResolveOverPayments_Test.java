...
/**
 * Automated tests for the Case Numbering changes to the Resolve Overpayments screen.
 *
 * @author Chris Vincent
 */
public class CaseManNumbering_ResolveOverPayments_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CaseManNumbering_ResolveOverPayments_Test ()
    {
        super (CaseManNumbering_ResolveOverPayments_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC063ResolveOverpaymentUtils = new UC063ResolveOverpaymentUtils (this);
    }

    /**
     * Checks that Case Number field validation is as expected on the Resolve Overpayments screen
    ...
    public void testCaseNumberValidationPreChange ()
    {
        try
        {
            ...
            // Get to the Resolve Overpayments screen
            mLoginAndNavigateToScreen ();

            // Set Enforcement Type to CASE
            myUC063ResolveOverpaymentUtils.setEnforcementType (AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_CASE);

            // Enter a 7 digit case number to ensure it is rejected
            myUC063ResolveOverpaymentUtils.setEnforcementNumber ("3NN0001");
            ...
            {
                myUC063ResolveOverpaymentUtils.setEnforcementNumber (caseArray[i]);
    ...
    /**
     * Checks that Warrant Number field validation is as expected on the Resolve Overpayments screen
     * BEFORE the new numbering scheme comes into place.
     */
    public void testWarrantNumberValidationPreChange ()
    {
        try
        {
            ...
            myUC063ResolveOverpaymentUtils
            ...
            {
                myUC063ResolveOverpaymentUtils.setEnforcementNumber (invalidWarrantArray[i]);
            ...
            {
                myUC063ResolveOverpaymentUtils.setEnforcementNumber (validWarrantArray[i]);
    ...
    /**
     * Checks that Local Warrant Number field validation is as expected on the Resolve Overpayments screen
     * BEFORE the new numbering scheme comes into place.
     */
    ...
    /**
     * Private function that logs the user into CaseMan and navigates to the Resolve Overpayments screen.
     */
    private void mLoginAndNavigateToScreen ()
    {
        ...
        myUC063ResolveOverpaymentUtils.handleStartOfDayProcess ();

...
/**
 * Automated tests for the Case Paid Pre Judgment functionality in the CCBC SDT release.
 *
 * @author Chris Vincent
 */
public class PaidPreJudgment_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public PaidPreJudgment_Test ()
    {
        super (PaidPreJudgment_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC002CaseEventUtils = new UC002CaseEventUtils (this);
    }

    /**
     * Tests that when Case Event 78 is created on a Northampton owned non-MCOL, non-CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent78_1 ()
    {
        try
        {
            ...
            // Error off the Case Event 78
            myUC002CaseEventUtils.selectCaseEventByEventId (EVENT_78);
    ...
    /**
     * Tests that when Case Event 78 is created on a CCBC owned MCOL case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent78_2 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
            ...
            // Create case event 78
            createCaseEvent78 ();
            final String paidDate = AbstractBaseUtils.now ();
    ...
    /**
     * Tests that when Case Event 78 is created on a Northampton owned MCOL case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent78_3 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 78 is created on a Northampton owned CCBC case, that no
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent78_4 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests that when Case Event 78 is created on a CCBC owned CCBC case, that a
     * notification is written to the MCOL_DATA table.
     */
    public void testCaseEvent78_5 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Private method to handle the creation of case event 78.
     *
     * @throws Exception Exception thrown creating event
     */
    private void createCaseEvent78 () throws Exception
    {
        /**
         * Create Event 78
         * No Subject
         ...
         * FCK Editor
         */
        final NewStandardEvent testEvent78 = new NewStandardEvent (EVENT_78);
        testEvent78.setSubjectParty ("Defendant 1 - DEFENDANT NAME");
        testEvent78.setProduceOutputFlag (false);

        // Add the event
        myUC002CaseEventUtils.addNewEvent (testEvent78, null);
    }

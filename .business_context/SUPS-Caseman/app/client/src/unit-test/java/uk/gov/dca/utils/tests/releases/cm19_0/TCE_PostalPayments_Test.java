...
/**
 * Automated tests for the TCE changes to the Create Postal Payments screen.
 *
 * @author Chris Vincent
 */
public class TCE_PostalPayments_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public TCE_PostalPayments_Test ()
    {
        super (TCE_PostalPayments_Test.class.getName ());
    ...
    public void testExecutionWarrantNonOverpayment ()
    {
        try
        {
            ...
            myUC059PostalPaymentUtils.loadEnforcement (homeExecutionWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);

            // Create the payment, overpaying by 1.00
            String transactionNumber;
            myUC059PostalPaymentUtils.setPaymentAmount ("191.00");
            ...
            myUC059PostalPaymentUtils.loadEnforcement (foreignExecutionWarrant,
    ...
    public void testControlHomeWarrantNonOverpayment ()
    {
        try
        {
            ...
            myUC059PostalPaymentUtils.loadEnforcement (homeControlWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            myUC059PostalPaymentUtils.loadEnforcement (foreignControlWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_FOREIGNWARRANT);
    ...
    public void testExecutionWarrantOverpayment ()
    {
        try
        {
            ...
            String transactionNumber;
            myUC059PostalPaymentUtils.setPaymentAmount ("191.01");
            myUC059PostalPaymentUtils.setPaymentType (AbstractSuitorsCashScreenUtils.PAYMENT_TYPE_CASH);
            myUC059PostalPaymentUtils.setRetentionType (AbstractSuitorsCashScreenUtils.RETENTION_TYPE_ORDINARY);
            transactionNumber = myUC059PostalPaymentUtils.saveScreen ();
    ...
    public void testOtherWarrantOverpayments ()
    {
        try
        {
            ...
            myUC059PostalPaymentUtils.loadEnforcement (possessionWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            myUC059PostalPaymentUtils.loadEnforcement (deliveryWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);
            ...
            myUC059PostalPaymentUtils.loadEnforcement (committalWarrant,
                    AbstractSuitorsCashScreenUtils.ENFORCEMENT_TYPE_HOMEWARRANT);

 ...
 */
public class CM_BIFItem19_7_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CM_BIFItem19_7_Test ()
    {
        super (CM_BIFItem19_7_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC002CaseEventUtils = new UC002CaseEventUtils (this);
    }

    /**
     * Tests the BMS code associated with case event 68 on a non-CCBC County Court case.
     */
    public void testCaseEvent68_1 ()
    {
        try
        {
            ...
            // Check BMS Task
            myUC002CaseEventUtils.selectCaseEventByEventId ("68");
    ...
    /**
     * Tests the BMS code associated with case event 68 on a non-CCBC High Court case.
     */
    public void testCaseEvent68_2 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests the BMS code associated with case event 68 on a CCBC case.
     */
    public void testCaseEvent68_3 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen
    ...
    /**
     * Tests the BMS code associated with case event 68 on an Insolvency case.
     */
    public void testCaseEvent68_4 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen

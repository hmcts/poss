...
/**
 * Automated tests ensuring that family enforcement cases do not produce a
 * REPORT_MAP row which is sent for bulk print.
 *
 * @author Chris Vincent
 */
public class RFS4813_5_Family_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public RFS4813_5_Family_Test ()
    {
        super (RFS4813_5_Family_Test.class.getName ());
    ...
    /**
     * Tests that when Case Event 442 is created on a Family Enforcement Case, the REPORT_MAP row is
     * NOT created.
     */
    public void testCaseEvent442_1 ()
    {
        try
        {
            ...
            assertEquals (2, DBUtil.getReportQueuePrintStatusForCaseEvent (EVENT442, caseNumber1));
    ...
    /**
     * Tests that when Case Event 442 is created on a Family Enforcement case, but the output is not
     * marked as final, the REPORT_MAP row is NOT created and when the user returns to the FCK Editor
     * and marks it as final, the REPORT_MAP row is still not created.
     */
    ...
    /**
     * Tests that when case event 442 on a family enforcement case is created, but the user clicks
     * the Cancel button on the FCK Editor, the REPORT_MAP row is not created and when the user double
    ...
    /**
     * Tests that when AE Avent 332 is created on a family enforcement case, the REPORT_MAP row is
     * not created.
     */
    public void testAEEvent332 ()
    {
        try
        {
            ...
            // Check that the REPORT_QUEUE row shows the output has not been printed locally
            assertEquals (2, DBUtil.getReportQueuePrintStatusForAEEvent (EVENT332, aeNumber1));
    ...
    /**
     * Tests that when AE Event 851 is created on a family enforcement case, the REPORT_MAP row is
     * not created.
     */
    public void testAEEvent851_1 ()
    {
        try
        {
            ...
            // Check that the REPORT_QUEUE row shows the output has not been printed locally
            assertEquals (2, DBUtil.getReportQueueORPrintStatusForAEEvent (EVENT851, aeNumber2, "P851-I"));
    ...
    /**
     * Test the creation of an AE (which produces AE Event 851) on a family enforcement case does not create
     * a REPORT_MAP row for P851.
     */
    ...
    /**
     * Tests that when AE Event 871 is created on a family enforcement case, the REPORT_MAP row
     * is not created.
     */
    public void testAEEvent871_1 ()
    {
        try
        {
            ...
            // Check that the REPORT_QUEUE row shows the output has not been printed locally
            assertEquals (2, DBUtil.getReportQueueORPrintStatusForAEEvent (EVENT871, aeNumber2, "P871"));
    ...
    /**
     * Tests that when AE Event 880 is created on a family enforcement case, the REPORT_MAP row
     * is not created.
     */
    public void testAEEvent880_1 ()
    {
        try
        {
            ...
            // Check that the REPORT_QUEUE row shows the output has not been printed locally
            assertEquals (2, DBUtil.getReportQueueORPrintStatusForAEEvent (EVENT880, aeNumber2, "P880"));
        }
        catch (final Exception e)
        {
            e.printStackTrace ();
    ...
    /**
     * Tests that when AE Event 883 is created on a family enforcement case, the REPORT_MAP row
     * is not created.
     */
    public void testAEEvent883_1 ()
    {
        try
        {
            ...
            // Check that the REPORT_QUEUE row shows the output has not been printed locally
            assertEquals (2, DBUtil.getReportQueueORPrintStatusForAEEvent (EVENT883, aeNumber2, "P883"));
            assertEquals (2, DBUtil.getReportQueueORPrintStatusForAEEvent (EVENT883, aeNumber2, "N64"));
        }
        catch (final Exception e)
        {
            e.printStackTrace ();

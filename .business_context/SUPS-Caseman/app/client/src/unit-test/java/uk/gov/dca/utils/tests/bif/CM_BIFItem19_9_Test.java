 ...
 */
public class CM_BIFItem19_9_Test extends AbstractCmTestBase
{
     ...
     * Constructor.
     */
    public CM_BIFItem19_9_Test ()
    {
        super (CM_BIFItem19_9_Test.class.getName ());
        this.nav = new Navigator (this);
        myUC002CaseEventUtils = new UC002CaseEventUtils (this);
    }

    /**
     * Tests the BMS code associated with case event 97 on a non-CCBC case.
     */
    public void testCaseEvent97_1 ()
    {
        try
        {
            ...
            // Check BMS Task
            myUC002CaseEventUtils.selectCaseEventByEventId ("97");
    ...
    /**
     * Tests the BMS code associated with case event 97 on a CCBC case.
     */
    public void testCaseEvent97_2 ()
    {
        try
        {
            // Log into SUPS CaseMan and load case on Case Events screen

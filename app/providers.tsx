...
const CLAIM_DATA: Record<string, { stateNames: string[]; flows: [number, number, string, boolean, boolean][]; eventDefs: [string, number, boolean, string, boolean, Record<string, boolean>][] }> = {
  MAIN_CLAIM_ENGLAND: {
    ...
    eventDefs: [['Submit Claim',0,false,'Claimant submits form',false,{Claimant:true}],['Validate',1,true,'System validates',true,{SystemAuto:true}],['Refer to Judge',1,false,'Caseworker escalates',false,{Caseworker:true}],['Auto-list',1,true,'Auto-list after 28d',true,{SystemAuto:true}],['Direct Listing',2,false,'Judge directs listing',false,{Judge:true}],['Strike Out',2,false,'Judge strikes out',false,{Judge:true}],['Record Outcome',3,false,'Record hearing outcome',true,{Caseworker:true}],['Close Case',4,true,'',false,{SystemAuto:true}]],
  },
  ACCELERATED_CLAIM_WALES: {
    ...
    eventDefs: [['File Claim',0,false,'Accelerated filing',false,{Claimant:true}],['Auto-validate',1,true,'System checks',false,{SystemAuto:true}],['List Hearing',2,true,'Fast-track listing',false,{SystemAuto:true}],['Grant Order',3,false,'Judge grants possession',false,{Judge:true}],['Execute Warrant',4,false,'Bailiff executes',false,{BailiffEnforcement:true}]],
  },
  COUNTER_CLAIM: {
    ...
    eventDefs: [['File Counter-Claim',0,false,'Defendant files',false,{Defendant:true}],['Link Claims',1,true,'System links to main',false,{SystemAuto:true}],['Refer to Judge',2,false,'Caseworker refers',false,{Caseworker:true}],['Join Hearing',3,false,'Judge joins cases',false,{Judge:true}],['Determine',4,false,'Judge determines outcome',true,{Judge:true}],['Close',5,true,'Auto-close',false,{SystemAuto:true}]],
  },
  COUNTER_CLAIM_MAIN_CLAIM_CLOSED: {
    ...
    eventDefs: [['File Counter-Claim',0,false,'Filed after main closed',false,{Defendant:true}],['Standalone Review',1,true,'Main claim detected closed',true,{SystemAuto:true}],['Refer',2,false,'Caseworker refers',false,{Caseworker:true}],['Determine',3,false,'Judge determines',false,{Judge:true}],['Close',4,true,'Auto-close',false,{SystemAuto:true}]],
  },
  ENFORCEMENT: {
    ...
    eventDefs: [['Request Warrant',0,false,'Claimant requests',false,{Claimant:true}],['Issue Warrant',0,false,'Court issues',false,{Caseworker:true}],['Assign Bailiff',1,false,'Assign enforcement',false,{CourtAdmin:true}],['Schedule',2,false,'Bailiff schedules',false,{BailiffEnforcement:true}],['Execute',3,false,'Carry out eviction',true,{BailiffEnforcement:true}],['Suspend',2,false,'Judge suspends warrant',false,{Judge:true}]],
  },
  APPEALS: {
    ...
    eventDefs: [['File Notice',0,false,'Appellant files',false,{Claimant:true,Defendant:true}],['Review Permission',1,false,'Judge reviews',false,{Judge:true}],['Grant',1,false,'Permission granted',false,{Judge:true}],['Refuse',1,false,'Permission refused',false,{Judge:true}],['List Appeal',2,false,'Caseworker lists',false,{Caseworker:true}],['Decide',3,false,'Judge decides appeal',true,{Judge:true}]],
  },
  GENERAL_APPLICATIONS: {
    ...
    eventDefs: [['File Application',0,false,'Party files application',false,{Claimant:true,Defendant:true}],['Refer',1,false,'Caseworker refers',false,{Caseworker:true}],['Decide',2,false,'Judge decides application',true,{Judge:true}],['Complete',3,true,'Auto-close',false,{SystemAuto:true}]],
  },
};
